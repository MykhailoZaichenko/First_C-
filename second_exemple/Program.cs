...
class Program
{
    ...
    //Масив кортежів в якому ми фіксуємо кількість кораблів. Вирішив використати його, бо при int[,] ships треба проп�[...]
    ...
    {
        //Виводить верхній рядок з номерами стовпців. Знайшов декілька облегшуючих фунцій Join() робить послідовні�[...]
        Console.Write("  ");
        ...
        {
            Console.Write((i + 1).ToString().PadLeft(2) + " "); // Виводить номер рядка починаючи з 1. А ToString().PadLeft(2) робить ганішим вивод, то[...]
